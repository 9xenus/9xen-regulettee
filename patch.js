...
// Wrap sections
// We will wrap sections using String.prototype.replace with regex

// Wrap KPI Cards to be in OVERVIEW or TELEMETRY
// Actually, it's easier to just put EVERYTHING in conditional renders using a simple trick.
code = code.replace(
  "{/* Executive Summary KPI Cards */}",
...
// Add REGULATORY_LAW block right before the final closing </div>
const lawCode = `
      </>)}
...
if (parts.length === 2) {
    ...
    // If it didn't split perfectly, we just append it
}
